//tealium universal tag - utag.24 ut4.0.201605112157, Copyright 2016 Tealium.com Inc. All Rights Reserved.
var s_account="myfamilyancestry";var s=s_gi(s_account);s.dynamicAccountSelection=false;s.dynamicAccountList="";s.trackDownloadLinks=true;s.trackExternalLinks=true;s.trackInlineStats=true;s.linkDownloadFileTypes="zip,exe,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";s.linkInternalFilters=".ancestry.,ancestrydev,ancestrystage,javascript";s.linkLeaveQueryString=false;s.linkTrackVars="None";s.linkTrackEvents="None";s.usePlugins=false;s.currencyCode="USD";s.visitorNamespace="ancestry";s.trackingServer="metrics.ancestry.com";s.trackingServerSecure="smetrics.ancestry.com";s.dc=122;var s_code='',s_objectID;function s_gi(un,pg,ss){var c="s.version='H.25.2';s.an=s_an;s.logDebug=function(m){var s=this,tcf=new Function('var e;try{console.log(\"'+s.rep(s.rep(s.rep(m,\"\\\\\",\"\\\\"
...
+"inkName=s.linkType=s.wd.s_objectID=s.ppu=s.pe=s.pev1=s.pev2=s.pev3='';if(s.pg)s.wd.s_lnk=s.wd.s_eo=s.wd.s_linkName=s.wd.s_linkType='';return code};"
+"s.trackLink=s.tl=function(o,t,n,vo,f){var s=this; s.lnk=o; s.linkType=t; s.linkName=n; if(f){s.bct=o;s.bcf=f}s.t(vo);};"
+"s.trackLight=function(p,ss,i,vo){var s=this;s.lightProfileID=p;s.lightStoreForSeconds=ss;s.lightIncrementBy=i;s.t(vo)};s.setTagContai"
...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1};u.o=s;u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)}
u.map={"page_name":"eVar41,pageName","beanstalk_invite":"prop56,eVar56","beanstalk_node":"eVar55,prop55","campaign":"campaign","content_usage":"eVar18","content_view":"eVar11","content_view_type":"prop15","customer_segment":"prop12","db_view":"prop1","ext_cmp":"prop53","flow_type":"prop36,eVar60","hint_accepted":"eVar26","hint_filters":"prop34","img_view_src":"prop47","int_cmp":"prop54","last_db_denied":"eVar1","last_flow_type":"eVar47","mrkt_region":"prop38,eVar38","new_img_viewr_action":"prop40,eVar40","offer_id":"eVar54","offer_pg_view":"eVar61","org_srch_query":"eVar52","place_gpid":"prop35","product_type":"prop10,eVar15","reg_type":"eVar48","related_rcds_src":"eVar36","related_rcds_tgt":"eVar37","searc_dbid":"prop22,eVar22","search_type":"prop46","server":"server","site_cobrand":"eVar33,prop33","srch_center":"eVar51","subscription_type":"eVar15","tmp_eVar":"eVar70","tmp_prop":"prop70","tree_hints":"eVar5","ucdmid":"prop11,prop67","webservice_id":"prop51","order_id":"eVar8","cp.ANCUUID":"prop5","dom.domain":"prop68","bait_eTrial":"eVar73"};u.extend=[function(a,b){s.trackTNT=new Function("v","p","b","var s=this,n='s_tnt',p=p?p:n,v=v?v:n,r='',pm=false,b=b?b:true;"
...
function sc_npv(v,va,d){s.linkTrackVars="";s.linkTrackEvents="";var tD=new Date();var cD=new Date(d);if(tD<cD||d==0){var vAr=v.split("|");var vaAr=va.split("|");for(var i=0;i<vAr.length;i++){s[vAr[i]]=vaAr[i];if(vaAr[i].match(/=/g)){vARX=vaAr[i].split("=");}if(s[vAr[i]].match(/event/g)){s.linkTrackEvents+=vARX[0]+",";s.linkTrackVars+='events,';}else{s.linkTrackVars+=vAr[i]+",";}}
...
if(s.linkTrackEvents.substring(s.linkTrackEvents.length-1,s.linkTrackEvents.length)==','){s.linkTrackEvents=s.linkTrackEvents.substring(0,s.linkTrackEvents.length-1);}s.tl(this,'o','customlink');}}
...
s.apl=new Function("l","v","d","u",""+"var s=this,m=0;if(!l)l='';if(u){var i,n,a=s.split(l,d);for(i=0;i<a."+"length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCas"+"e()));}}if(!m)l=l?l+d+v:v;return l");var fs_url=document.location.href;if(s.c_r('fs_dnaQ')){var fs_cV=s.c_r('fs_dnaQ');var fs_cc=fs_cV.split(',');var fs_ccL=fs_cc.length;}
else{s.c_w('fs_dnaQ','0',0);var fs_cV='0';}
if(fs_url.indexOf('dna.ancestry.com/#/tests')!=-1||fs_url.indexOf('dna.ancestry.com/#/matches')!=-1||fs_url.indexOf('dna.ancestry.com/#/ethnicity')!=-1){if(fs_url.indexOf('dna.ancestry.com/#/tests')!=-1){if(fs_cV.indexOf('dna.ancestry.com/#/tests')==-1){fs_cV=fs_cV+','+fs_url;}}
if(fs_url.indexOf('dna.ancestry.com/#/matches')!=-1){if(fs_cV.indexOf('dna.ancestry.com/#/matches')==-1){fs_cV=fs_cV+','+fs_url;}}
if(fs_url.indexOf('dna.ancestry.com/#/ethnicity')!=-1){if(fs_cV.indexOf('dna.ancestry.com/#/ethnicity')==-1){fs_cV=fs_cV+','+fs_url;}}s.c_w('fs_dnaQ',fs_cV,0);}
if(fs_ccL>=3){s.c_w('fs_dna','true',0);}
var agent=navigator.userAgent.toLowerCase();var otherBrowser=(agent.indexOf("series60")!=-1)||(agent.indexOf("symbian")!=-1)||(agent.indexOf("windows ce")!=-1)||(agent.indexOf("blackberry")!=-1);var mobileOS=typeof orientation!='undefined'?true:false;var touchOS=('ontouchstart'in document.documentElement)?true:false;var iOS=(navigator.platform.indexOf("iPhone")!=-1)||(navigator.platform.indexOf("iPad")!=-1)?true:false;var android=(agent.indexOf("android")!=-1)||(!iOS&&!otherBrowser&&touchOS&&mobileOS)?true:false;s.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!m.s.wd[o])m.s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._d=0;p.disable=0;p"
...
s.tnt=s.trackTNT();if(b['action']){if(b.action=='none'){return false;}
s.prop70=b.action;sc_npv('prop70',s.prop70,0);return false;}
...
if(loc.indexOf('wiz2.ancestry.com/Records/SEO~Records')!=-1){pName='ancestry '+sc_geo+' : wiz2 : seo : '+locP[5];}}
...
pName=pName.toLowerCase();b['page_name']=pName;if(loc.indexOf('dna.ancestry')!=-1){if(b['page_name']=='none : none : none : needs valid page name'&&b['dom.pathname']=='/'){b['page_name']='ancestry us : dna : loading';}}
if(loc.indexOf('order.ancestry')!=-1){if(b['page_name']=='none : none : none : needs valid page name'){b['page_name']='ancestry us : secure : loading';}}
if(s_account=='myfamilyancestry'){if(b['dom.domain']=='dna.ancestry.cm'&&b['dom.pathname']=='/'){b['page_name']='ancestry us : dna : home : home';}}else if(s_account=='ancestryca'){if(b['dom.domain']=='dna.ancestry.ca'&&b['dom.pathname']=='/'){b['page_name']='ancestry ca : dna : home : home';}}else if(s_account=='ancestryse'){if(b['dom.domain']=='dna.ancestry.cse'&&b['dom.pathname']=='/'){b['page_name']='ancestry se : dna : home : home';}}else if(s_account=='ancestryuki'){if(b['dom.domain']=='dna.ancestry.co.uk'&&b['dom.pathname']=='/'){b['page_name']='ancestry uk : dna : home : home';}}
...
if(s.visitorMigrationKey||s_visitorMigrationKey){return false;}},function(a,b){if(s.getQueryParam('utm_source')){cm_source='unknown';cm_site='unknown';cm_source=s.getQueryParam('utm_source').toLowerCase();if(s.getQueryParam('utm_site')&&(cm_source=="taboola")){cm_site=s.getQueryParam('utm_site').toLowerCase();}else if(s.getQueryParam('utm_term')&&(cm_source=="taboola")){cm_site=s.getQueryParam('utm_term').toLowerCase();}else if(s.getQueryParam('utm_term')&&(cm_source=="outbrain")){cm_site=s.getQueryParam('utm_term').toLowerCase();}
if(cm_source==''){cm_source='unknown';}if(cm_site==''){cm_source='unknown';}
s.eVar66=cm_source+" : "+cm_site;}else{s.eVar66='';}
if(typeof(b['dbSection'])!='undefined'){if(b['dbSection']=='military'){s.prop70='search category : military';}}
if(typeof(b['search_category'])!='undefined'){if(b['search_category']=='Military'){s.prop70='search category : military';}}
if(s.getQueryParam('subid')){s.c_w('an_subid',s.getQueryParam('subid'),0);}
if(s.getQueryParam('sub_ad')){s.c_w('an_sub_ad',s.getQueryParam('sub_ad'),0);}
if(((utag.data['dom.url'].indexOf('trees.ancestry')!=-1)&&(utag.data['dom.pathname'].indexOf('/tree/')!=-1))||((utag.data['dom.domain'].toLowerCase()=='wiz2.ancestry.com')&&(utag.data['dom.hash'].toLowerCase()=='/searchresults')&&(typeof(utag.data['cp.LAU'])!='undefined')&&(utag.data['cp.LAU']!='00000000-0000-0000-0000-000000000000'))||((utag.data['bait_hasTree']>=1))){var e=new Date();e.setDate(e.getDate()+30);s.c_w('an_hasTree','1',e);}
if(utag.data['dom.query_string'].indexOf('o_xid=69630')>=1){var anc_d=new Date();anc_d.setTime(anc_d.getTime()+(30*24*60*60*1000));var anc_expires="expires="+anc_d.toUTCString();document.cookie="anc_pch=true; "+anc_expires+"; domain=.ancestry.com; path=/";}
if(typeof(SOASTA)!='undefined'){if(SOASTA.page_group=='POSTHASTE'){s.eVar4='46923';}}}];u.send=function(a,b,c,d,e,f,g,h,ev,evt){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:24");for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};if(a=="link"){u.ltflag=true;if(typeof b.linkTrackVars=="undefined"){u.ltv=[]}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('24','ancestry.main');}catch(e){};function sc_npv(v,va,d){s.linkTrackVars="";s.linkTrackEvents="";var tD=new Date();var cD=new Date(d);if(tD<cD||d==0){var vAr=v.split("|");var vaAr=va.split("|");for(var i=0;i<vAr.length;i++){if(vAr[i]=='prop70'){utag.data['action']=vaAr[i];}s[vAr[i]]=vaAr[i];if(s[vAr[i]].match(/event/g)){s.linkTrackEvents+=vaAr[i]+",";s.linkTrackVars+='events,';}
else{s.linkTrackVars+=vAr[i]+",";}}if(s.linkTrackVars.substring(s.linkTrackVars.length-1,s.linkTrackVars.length)==','){s.linkTrackVars=s.linkTrackVars.substring(0,s.linkTrackVars.length-1);}
...
utag.data['call_type']='nonpage view';s.tl(this,'o','customlink');}}
...
if(typeof(dna_deny)!=='undefined'){if(dna_deny===true&&s.pageName=='ancestry us : dna : membermatch : at member match'){s.pageName='ancestry us : dna : offer : deny : dna match';s.events='event3';}}
s.t();}
