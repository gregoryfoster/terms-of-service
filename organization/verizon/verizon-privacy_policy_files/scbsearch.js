...
var scbSrcArrShop=new Array('my.verizon.com/shop','www22.verizon.com/residential','surround.verizon.com/shop','shop.verizon.com','www22.verizon.com/home','/residentialhelp/','/support/residential/');
...
if(scbIsVZ)scbSearchArr.push(new Array('w','Web','Search the Web','http://searchresults.verizon.com/search/index.php?context=MyVrzn&q=','scb3srcwww','Powered by Google'));
...
d.write('\n<form name="scbsearchform" id="scbsearchform" method="get" action="http://searchresults.verizon.com/search/index.php?context=MyVrzn&q=" onsubmit="scbCkSrcVal(document.scbsearchform);return false;" style="margin:0;display:inline;">');
...
function scbSrcCheck(){
	...
	if(oDisp){
		...
		if(typeof(bLog20)!='undefined'&&bLog20){
			...
			if((oDisp.display=='block'||oDisp.display=='')&&!scbCollapsed&&window.location.href.toLowerCase().indexOf('forums.verizon.com')==-1){document.scbsearchform.q.focus();}
		}
	}
}
